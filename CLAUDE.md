...
- `HarfordQuests` almacena el estado individual de una mision por `id`. Hoy los contratos son el unico origen real de misiones, fuera de debug. `contract.objectives` son textos de presentacion: no hay progreso por objetivo ni auto-completado. Solo el DM autorizado publica `completed` y los clientes reconcilian recompensas.
