...
| `Harford/DnD/UI/HarfordActionBars.lua` | Barra de accion propia (config-gated `actionbar`) para colocar habilidades del Libro; no secuestra los ActionButton de Blizzard | pequeño |
...
| `Harford/DnD/UI/HarfordDnDAttackUI.lua` | Controles visuales de Ataque y tracker de movimiento activado solo durante la medición; reglas/tiradas permanecen fuera | pequeño |
...
| `Harford/DnD/Data/HarfordDnDBook.lua` | Libro hardcodeado de clases/subclases/rasgos; efectos declarativos, sin Lua arbitrario | pequeño |
