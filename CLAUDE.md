...
| `Harford/Professions/HarfordCraftSkin.lua` | Armazon de la ventana de recetas GENERADO desde la captura del frame nativo con `tools/codice/gen_frame_from_probe.py`. No editar a mano: se regenera | pequeño |
