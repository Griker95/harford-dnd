...
API.CLASSES = {
    {
        ...
        features = {
            ...
            { id = "cdm_poder_runico", level = 1, name = "Poder Runico", type = "recurso", description = "Reserva de dados d6 (1 + nivel CdM) que recarga en descanso largo; no gastas mas dados que tu Mod. Carisma. Usos: Espiral de la Muerte y Golpe Runico (daño necrotico extra).", effects = {} },
            { id = "cdm_estilo_combate", level = 2, name = "Estilo de Combate", type = "choice", description = "Adoptas un estilo de combate como especialidad.", effects = {}, choice = {
                ...
                options = {
                    ...
                    { id = "gran_arma",       label = "Gran Lucha con Armas (repetir 1-2 a dos manos)", effects = {} },
                    { id = "guerrero_profano", label = "Guerrero Profano (2 trucos de brujo, Carisma)", effects = {} },
                    { id = "dos_armas",       label = "Combate con Dos Armas (+mod al 2º ataque)", effects = {} },
                },
            } },
    ...
    },
    {
        ...
        features = {
            { id = "dh_defensa_sin_armadura", level = 1, name = "Defensa sin Armadura", type = "informativo", description = "Sin armadura ni escudo, tu CA = 10 + Mod. Destreza + Mod. Inteligencia.", effects = {} },
            ...
            { id = "dh_vil", level = 2, name = "Vil", type = "recurso", description = "Puntos de vil (= nivel) para alimentar caracteristicas (Mordida de Demonio, Potenciar Protecciones, Momentum). CD de Vil = 8 + comp + Mod. Inteligencia. Recargan en descanso.", effects = {} },
    ...
    },
    {
        ...
        subclasses = {
            ...
            { id = "feral", name = "Camino Feral", features = {
                ...
                { id = "dru_fer_marca_ursol", level = 2, name = "Marca de Ursol", type = "informativo", description = "Puedes lanzar conjuros mientras estas transformado (ignoras componentes V/S y materiales sin coste). 2 usos por descanso.", effects = {} },
                ...
                { id = "dru_fer_instintos", level = 6, name = "Instintos Primales", type = "informativo", description = "Sumas tu Mod. Sabiduria a la iniciativa y no puedes ser sorprendido mientras estas despierto.", effects = {} },
        ...
        features = {
            ...
            { id = "dru_cambio_forma", level = 2, name = "Cambio de Forma", type = "informativo", description = "Accion: asumes una forma druidica conocida (gato, oso, lechucico lunar, arbol...). Mas formas a niveles 4 y 8.", effects = {} },
    ...
    },
    {
        ...
        subclasses = {
            ...
            { id = "supervivencia", name = "Supervivencia", features = {
                ...
                { id = "caz_sup_lobo_salvaje", level = 3, name = "Lobo Solitario: Nacido para ser Salvaje", type = "informativo", description = "Sin compañero bestial, tus ataques con arma son criticos con 19-20 y Desengancharte es accion adicional.", effects = {} },
        ...
        features = {
            { id = "caz_marca_cazador", level = 1, name = "Marca del Cazador", type = "informativo", description = "Accion adicional: marcas una criatura a 120 pies. Una vez por turno, +1d4 de daño al golpearla con arma (sube con nivel). Ventaja en Percepcion/Supervivencia para encontrarla.", effects = {} },
            { id = "caz_explorador_natural", level = 1, name = "Explorador Natural", type = "informativo", description = "Sumas tu Mod. Sabiduria a la iniciativa; ventaja en el primer turno contra criaturas que no han actuado; ventajas viajando por la naturaleza.", effects = {} },
            { id = "caz_estilo_combate", level = 2, name = "Estilo de Combate", type = "choice", description = "Adoptas un estilo de combate como especialidad.", effects = {}, choice = {
                ...
                options = {
                    ...
                    { id = "dos_armas",   label = "Combate con Dos Armas (+mod al 2º ataque)", effects = {} },
                    { id = "gran_arma",   label = "Combate con Arma Grande (repetir 1-2 a dos manos)", effects = {} },
                },
            } },
            { id = "caz_enfoque", level = 2, name = "Enfoque", type = "recurso", description = "Dados de enfoque (d8, segun la tabla) para Llamada de lo Salvaje, Ataque Preciso y Tacticas de Supervivencia. Recargan en descanso.", effects = {} },
    ...
    },
    {
        ...
        features = {
            ...
            { id = "mago_fuente_magia", level = 2, name = "Fuente de Magia", type = "recurso", description = "Puntos de hechiceria (= nivel) para Lanzamiento Flexible (convertir puntos en espacios de conjuro y viceversa). Recargan en descanso largo.", effects = {} },
    ...
    },
    {
        ...
        features = {
            { id = "monje_defensa_sin_armadura", level = 1, name = "Defensa sin Armadura", type = "informativo", description = "Sin armadura ni escudo, tu CA = 10 + Mod. Destreza + Mod. Sabiduria.", effects = {} },
            ...
            { id = "monje_chi", level = 2, name = "Chi", type = "recurso", description = "Puntos de chi (= nivel) para Puños de Furia, Danza Elusiva, Paso del Viento y Efusion. CD de Chi = 8 + comp + Mod. Sabiduria. Recargan en descanso.", effects = {} },
            ...
            { id = "monje_golpes_empoderados_chi", level = 6, name = "Golpes Empoderados por el Chi", type = "pasivo", description = "Tus golpes desarmados cuentan como magicos para superar resistencias e inmunidades no magicas.", effects = {} },
        },
    },
    {
        ...
        features = {
            { id = "pal_sentido_divino", level = 1, name = "Sentido Divino", type = "informativo", description = "Accion: detectas celestiales, infernales y no-muertos a 60 pies, y lugares/objetos consagrados o profanados. Usos = 1 + Mod. Carisma.", effects = {} },
            ...
            { id = "pal_estilo_combate", level = 2, name = "Estilo de Combate", type = "choice", description = "Adoptas un estilo de combate como especialidad.", effects = {}, choice = {
                ...
                options = {
                    ...
                    { id = "gran_arma",        label = "Gran Arma (repetir 1-2 a dos manos)",     effects = {} },
            ...
            { id = "pal_golpe_cruzado", level = 2, name = "Golpe del Cruzado", type = "informativo", description = "Al golpear cuerpo a cuerpo, gasta ranura de conjuro: +2d8 radiante (1er nivel; +1d8 por nivel superior, max 6d8; +1d8 contra no-muertos/infernales).", effects = {} },
            { id = "pal_camino_sagrado", level = 3, name = "Camino Sagrado", type = "informativo", description = "Eliges tu camino (de lo Sagrado, de la Proteccion o de la Retribucion). Concede rasgos y Canalizar Divinidad en niveles 3, 7, 15 y 20.", effects = {} },
            ASI("paladin", 4),
            ...
            { id = "pal_aura_proteccion", level = 6, name = "Aura de Proteccion", type = "informativo", description = "Tu y aliados a 10 pies suman tu Mod. Carisma (minimo +1) a sus tiradas de salvacion mientras estes consciente.", effects = {} },
        },
    },
    {
    ...
    },
    {
        ...
        features = {
            ...
            { id = "pic_ataque_furtivo", level = 1, name = "Ataque Furtivo", type = "informativo", description = "Una vez por turno, +1d6 de daño (sube con nivel) a una criatura si tienes ventaja o un aliado adyacente, con arma ligera/precision/distancia.", effects = {} },
            ...
            { id = "pic_energia", level = 2, name = "Energia", type = "recurso", description = "Puntos de energia (segun la tabla) para maniobras (Mutilar, Exponer Armadura, Garrote). CD de Energia = 8 + comp + Mod. Destreza. Recargan en descanso.", effects = {} },
            ...
            ASI("picaro", 4),
            { id = "pic_esquiva_sobrenatural", level = 5, name = "Esquiva Sobrenatural", type = "informativo", description = "Reaccion al recibir un ataque de un atacante visible: reduces el daño a la mitad.", effects = {} },
    ...
    },
    {
        ...
        features = {
            ...
            { id = "cha_totemista", level = 2, name = "Totemista", type = "recurso", description = "Accion adicional: invocas un totem (CA 15, PG = 2x nivel) con poderes (Resistencia Elemental + el de tu afinidad). 2 usos por descanso (mas a niveles 10 y 18).", effects = {} },
            { id = "cha_afinidad_elemental", level = 2, name = "Afinidad Elemental", type = "choice", description = "Te sintonizas con un elemento.", effects = {}, choice = {
                slots = 1,
                options = {
                    { id = "aire",  label = "Aire (+5 velocidad, +comp a iniciativa)", effects = {} },
                    { id = "tierra", label = "Tierra (competencia en salvacion de Constitucion)", effects = { { kind = "saveProf", ability = "Constitucion" } } },
                    { id = "fuego", label = "Fuego (+comp de daño por fuego, 1/turno)", effects = {} },
    ...
    },
    {
        ...
        features = {
            ...
            { id = "bru_fragmentos_alma", level = 3, name = "Fragmentos de Alma", type = "recurso", description = "Cristales de alma (hasta 3) que gastas para potenciar conjuros (Circulo de Conjuros, Quemar Alma, Ritos de Alma). Los creas en descanso o de criaturas moribundas.", effects = {} },
            ASI("brujo", 4),
        ...
        features = {
            { id = "guerrero_estilo_combate", level = 1, name = "Estilo de Combate", type = "choice", description = "Adoptas un estilo de combate como especialidad. Elige una opcion.", effects = {}, choice = {
                ...
                options = {
                    ...
                    { id = "gran_arma",  label = "Gran Arma (repetir 1-2 en daño a dos manos)", effects = {} },
                    { id = "proteccion", label = "Proteccion (desventaja a atacantes, con escudo)", effects = {} },
                    { id = "dos_armas",  label = "Combate con Dos Armas (+mod al daño del 2º ataque)", effects = {} },
                },
            } },
            ...
            { id = "guerrero_furia_interna", level = 2, name = "Furia Interna", type = "recurso", description = "Ganas puntos de Furia al dañar con armas; los gastas en maniobras (Carga, Desarme, Golpe Furioso). CD Furia = 8 + comp + Mod. Fuerza.", effects = {} },
...
function API.FindClassIdByText(text)
    ...
    EnsureIndex()
    for _, classDef in ipairs(API.CLASSES) do
        if clean:find(Normalize(classDef.name), 1, true)
            or clean:find(Normalize(classDef.id), 1, true)
        then
            return classDef.id
        end
    end
