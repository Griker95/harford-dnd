...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    subclasses = {
        ...
        { id = "venganza", name = "Venganza", desc = "Defensa demoniaca que absorbe el castigo y lo devuelve.", features = {
            ...
            { id = "dh_ven_tormento", level = 3, name = "Tormento", type = "maniobra", description = "Acción: una criatura a 30 pies con salvación de Sabiduría o desventaja en ataques contra otros que no seas tu durante 1 minuto.", effects = {
        ...
        { id = "ira", name = "Ira", desc = "Furia desatada que crece con el frenesi del combate.", features = {
            ...
            { id = "dh_ira_llamas", level = 3, name = "Llamas del caos", type = "maniobra", description = "Accion de Ataque: manifiestas llamas viles como un ataque a distancia de 9 metros. Tienes competencia y sumas tu Mod. Destreza al ataque y al dano. Al impactar inflige 1d6 de dano por fuego (1d10 a nivel 11). Con Ataque Adicional puedes usarlo en cualquiera de tus ataques.", effects = {
    ...
    features = {
        ...
        { id = "dh_momentum", level = 2, name = "Momentum", type = "accion", resourceKey = "fel_point", resourceCost = 1, spendResourceOnAnnounce = true, description = "Como acción adicional, gastas 1 punto de Vil para Correr o Desengancharte. Tu distancia de salto se duplica durante ese turno; el movimiento se resuelve en juego.", effects = {} },
