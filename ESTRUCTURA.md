...
| `HarfordUISounds.lua` | 78 | Sonidos de interfaz centralizados. |
...
| Archivo | Lineas | Rol |
|---|--:|---|
| `HarfordTRP3.lua` | 2575 | Lectura segura de perfiles TRP3: ficha de jugador, stat block de NPC, enlaces y escritura del About. |
