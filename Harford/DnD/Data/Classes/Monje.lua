...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    features = {
        ...
        { id = "monje_chi_punos", level = 2, name = "Punos de Furia", cast = "accion_adicional", type = "accion", resourceKey = "chi", resourceCost = 1, spendResourceOnAnnounce = true, description = "Inmediatamente despues de tomar la accion de Ataque en tu turno, gastas 1 punto de chi para realizar dos golpes desarmados como accion adicional.", effects = {} },
        ...
        { id = "monje_chi_paso", level = 2, name = "Paso del Viento", cast = "accion_adicional", type = "accion", resourceKey = "chi", resourceCost = 1, spendResourceOnAnnounce = true, description = "Gastas 1 punto de chi para tomar la accion de Desengancharse o Correr como accion adicional en tu turno, y tu distancia de salto se duplica ese turno.", effects = {} },
