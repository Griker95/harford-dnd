...
{
    id = "guerrero", name = "Guerrero", nameF = "Guerrera", desc = "El combatiente completo: cualquier arma, cualquier armadura. Sostiene la primera línea o la rompe, según se decante por las armas, la ira o el escudo.", hitDie = 10, startingGold = { dice = 5, sides = 4, multiplier = 1 },
