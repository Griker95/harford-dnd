...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    subclasses = {
        ...
        { id = "restauracion", name = "Restauracion", desc = "Sanacion sostenida con magia de la naturaleza.", features = {
            ...
            { id = "restauracion_corteza_de_hierro", level = 6, name = "Corteza de Hierro", type = "informativo", cast = "reaccion", description = "A partir del nivel 6, cuando tú o una criatura dentro de 9,1 metros de ti reciban daño por ácido, frío, fuego, relámpago o trueno, puedes usar tu reacción para otorgar resistencia a la criatura contra esa instancia del daño.", effects = {} },
