...
API.RACES = {
    ...
    },
    {
        ...
        subraces = {
            ...
            { id = "hierro_negro", name = "Enano Hierro Negro", desc = "Enanos oscuros ligados al fuego y la magia, antano siervos de Ragnaros en las profundidades.", traits = {
                ...
                { id = "ena_hn_vision", name = "Vision en la oscuridad superior", type = "informativo", description = "Visión en la oscuridad de 36 metros.", effects = {} },
            } },
        },
        traits = {
    ...
    },
    {
        ...
        subraces = {
            { id = "altonato", name = "Altonato", desc = "Kaldorei de Eldre'Thalas (los Shen'dralar/Altonato), eruditos arcanos de la antigua Dire Maul; conservan un saber mágico vedado al resto de los suyos.", traits = {
                ...
                { id = "eln_alt_erudito", name = "Erudito arcano", type = "informativo", description = "Conoces el truco Mano de mago. A nivel 3 puedes lanzar Detectar magia 1 vez al día; a nivel 5, Identificar 1 vez al día. La característica para estos conjuros es Inteligencia.", effects = {} },
                { id = "eln_alt_proteccion", name = "Proteccion mental", type = "informativo", description = "Ventaja en todas las tiradas de salvación de Inteligencia, Sabiduría y Carisma contra magia.", effects = {} },
            } },
        },
        traits = {
            ...
            { id = "eln_vision", name = "Vision en la oscuridad superior", type = "informativo", description = "Puedes ver en penumbra hasta 36 metros como luz brillante y en oscuridad como penumbra, todo en un tono violeta.", effects = {} },
    ...
    },
    {
        ...
        subraces = {
            ...
            { id = "man_ari", name = "Man'ari", desc = "Draenei corrompidos por la energia vil de la Legion Ardiente; cuerpo y alma alterados por fuerzas infernales. Algunos aun caminan por Azeroth buscando redencion... o poder.", traits = {
                ...
                { id = "dra_man_magia", name = "Magia vil", type = "informativo", description = "Conoces el truco Taumaturgia. A nivel 3 puedes lanzar Reprension Infernal 1/descanso largo; a nivel 5, Oscuridad 1/descanso largo. La característica para estos conjuros es Carisma.", effects = {} },
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "hua_vision", name = "Vision en la oscuridad", type = "informativo", description = "Puedes ver en luz tenue hasta 18 metros como si fuera luz brillante, y en la oscuridad como si fuera luz tenue. No puedes distinguir colores en la oscuridad, solo tonos de gris.", effects = {} },
            { id = "hua_mordida", name = "Mordida", type = "informativo", description = "En forma huargen, si aciertas en un ataque desarmado, infliges 1d6 + Mod. Fuerza de daño.", effects = {} },
            { id = "hua_oido", name = "Oido y olfato agudo", type = "informativo", description = "Ventaja en las pruebas de Percepción que dependan del oído o el olfato.", effects = {} },
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "ren_vision", name = "Vision en la oscuridad", type = "informativo", description = "Visión en la oscuridad a 18 metros (tonos de gris).", effects = {} },
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "tro_vision", name = "Vision en la oscuridad", type = "informativo", description = "Visión en la oscuridad a 60 pies (tonos de gris).", effects = {} },
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "gob_tratos", name = "Mejores tratos", type = "informativo", description = "Al regatear (Carisma/Persuasión), competente y sumas el doble de tu bono de competencia.", effects = {} },
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "vul_desierto", name = "Nacido del desierto", type = "informativo", description = "Estás naturalmente adaptado a climas cálidos.", effects = {} },
            ...
            { id = "vul_oido", name = "Oido agudo", type = "informativo", description = "Ventaja en pruebas de Sabiduría (Percepción) basadas en el oído.", effects = {} },
