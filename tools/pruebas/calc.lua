...
chk("y el contador no arranca ni en tu turno",
    ataque:find("if not aMano and API.ModoLibre then return end", 1, true) ~= nil, true)
chk("la casa vive aparte del ancla del muro",
