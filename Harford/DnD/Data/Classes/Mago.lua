...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    features = {
        ...
        { id = "mago_crear_espacio", level = 2, name = "Crear espacio de conjuro", type = "accion", description = "Accion adicional: transformas puntos de hechiceria en un espacio de conjuro. Coste: 2 puntos para uno de 1.o, 3 para 2.o, 5 para 3.o, 6 para 4.o y 7 para 5.o. Los espacios creados desaparecen al terminar un descanso largo. No puedes crear espacios por encima del 5.o nivel.", actionKind = "slotConversion", slotConversion = { mode = "create", resource = "mage_point" }, effects = {} },
        { id = "mago_convertir_espacio", level = 2, name = "Convertir espacio en puntos", type = "accion", description = "Accion adicional: gastas un espacio de conjuro y ganas puntos de hechiceria iguales al nivel del espacio.", actionKind = "slotConversion", slotConversion = { mode = "convert", resource = "mage_point" }, effects = {} },
        ...
        { id = "mago_metamagia", level = 3, name = "Metamagia", type = "choice", description = "Aprendes dos opciones de metamagia para alterar tus conjuros gastando puntos de hechicería (aprendes mas a niveles 10 y 17).", effects = {}, choice = {
            slots = 2,
            options = {
                { id = "cuidadoso", label = "Conjuro Cuidadoso (1 punto)", desc = "Al lanzar un conjuro que obliga a otras criaturas a una salvacion, gastas 1 punto de hechiceria y eliges un numero de esas criaturas igual a tu Mod. Inteligencia (minimo una): tienen exito automaticamente en su salvacion.", effects = {} },
                { id = "distante", label = "Conjuro Distante (1 punto)", desc = "Al lanzar un conjuro con un alcance de 1,5 metros o mas, gastas 1 punto para duplicar su alcance. Si el alcance es de toque, pasa a 9 metros.", effects = {} },
                { id = "potenciado", label = "Conjuro Potenciado (1 punto)", desc = "Al tirar el dano de un conjuro, gastas 1 punto para repetir un numero de dados de dano igual a tu Mod. Inteligencia (minimo 1). Debes usar los nuevos resultados. Puedes usarlo aunque ya hayas usado otra metamagia en ese conjuro.", effects = {} },
                { id = "prolongado", label = "Conjuro Prolongado (1 punto)", desc = "Al lanzar un conjuro con duracion de 1 minuto o mas, gastas 1 punto para duplicar su duracion, hasta un maximo de 24 horas.", effects = {} },
                { id = "intensificado", label = "Conjuro Intensificado (3 puntos)", desc = "Al lanzar un conjuro que obliga a una criatura a una salvacion para resistir sus efectos, gastas 3 puntos para dar a un objetivo desventaja en su PRIMERA salvacion contra el conjuro. En el manual aparece con el mismo nombre que Conjuro Potenciado.", effects = {} },
                { id = "rapido", label = "Conjuro Rapido (2 puntos)", desc = "Al lanzar un conjuro con tiempo de lanzamiento de 1 accion, gastas 2 puntos para cambiarlo a accion adicional en ese lanzamiento.", effects = {} },
                { id = "sutil", label = "Conjuro Sutil (1 punto)", desc = "Al lanzar un conjuro, gastas 1 punto para lanzarlo sin componentes somaticos ni verbales.", effects = {} },
