    ...
    },
    {
        ...
        subraces = {
            { id = "raza_elfo_noche_kaldorei", name = "Elfo de la Noche", nameF = "Elfa de la Noche", desc = "Kaldorei guardianes de la naturaleza: cazadores silenciosos que se funden con el bosque y la sombra.", traits = {
                { id = "eln_kal_inc", name = "Incremento de caracteristica", type = "pasivo", description = "Destreza +2 y Sabiduría +1.", effects = {
            ...
            { id = "raza_elfo_noche_altonato", name = "Altonato", nameF = "Altonata", desc = "Kaldorei de Eldre'Thalas (los Shen'dralar/Altonato), eruditos arcanos de la antigua Dire Maul; conservan un saber mágico vedado al resto de los suyos.", traits = {
                { id = "eln_alt_inc", name = "Incremento de caracteristica", type = "pasivo", description = "Inteligencia +2 y Sabiduría +1.", effects = {
    ...
    },
    {
        ...
        subraces = {
            ...
            { id = "raza_draenei_forjado_luz", name = "Draenei Forjado por la Luz", nameF = "Draenei Forjada por la Luz", desc = "Cruzados imbuidos de Luz Sagrada, forjados como arma viviente contra la Legion Ardiente.", traits = {
                ...
                { id = "dra_fl_juicio", name = "Juicio de la Luz", type = "pasivo", description = "Conoces luz; a niveles 3/5 lanzas rayo guiador / golpe de marca (Sabiduría).", spellGrants = { { level = 0, ids = { "luz" }, ability = "Sabiduria" }, { level = 1, ids = { "saeta_guiada" }, ability = "Sabiduria", minCharacterLevel = 3, note = "1/dia desde nivel 3" }, { level = 2, ids = { "castigo_marcador" }, ability = "Sabiduria", minCharacterLevel = 5, note = "1/dia desde nivel 5" } }, effects = {} },
            } },
            { id = "raza_draenei_tabido", name = "Draenei Tabido", nameF = "Draenei Tábida", desc = "Draenei rotos por la energia vil; marginados pero resistentes y perseverantes.", traits = {
                ...
                { id = "dra_tab_elemental", name = "Vinculo elemental", type = "pasivo", description = "Conoces escarcha; a niveles 3/5 lanzas temblor de tierra / rafaga de viento (Sabiduría).", spellGrants = { { level = 0, ids = { "mordedura_helada" }, ability = "Sabiduria" }, { level = 1, ids = { "temblor_de_tierra" }, ability = "Sabiduria", minCharacterLevel = 3, note = "1/dia desde nivel 3" }, { level = 2, ids = { "rafaga_de_viento" }, ability = "Sabiduria", minCharacterLevel = 5, note = "1/dia desde nivel 5" } }, effects = {} },
            ...
            { id = "raza_draenei_man_ari", name = "Man'ari", desc = "Draenei corrompidos por la energia vil de la Legion Ardiente; cuerpo y alma alterados por fuerzas infernales. Algunos aun caminan por Azeroth buscando redencion... o poder.", traits = {
                ...
                { id = "dra_man_magia", name = "Magia vil", type = "pasivo", description = "Conoces el truco Taumaturgia. A nivel 3 puedes lanzar Reprension Infernal 1/descanso largo; a nivel 5, Oscuridad 1/descanso largo. La característica para estos conjuros es Carisma.", spellGrants = { { level = 0, ids = { "taumaturgia" }, ability = "Carisma" }, { level = 1, ids = { "reprension_infernal" }, ability = "Carisma", minCharacterLevel = 3, note = "1/descanso largo desde nivel 3" }, { level = 2, ids = { "oscuridad" }, ability = "Carisma", minCharacterLevel = 5, note = "1/descanso largo desde nivel 5" } }, effects = {} },
