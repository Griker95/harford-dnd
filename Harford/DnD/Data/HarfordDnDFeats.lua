...
API.FEATS = {
    -- ===== Dotes especiales =====
    {
        id = "feat_mago_de_batalla", icon = "spell_mage_arcaneorb", requiredCaster = "any", name = "Mago de batalla", requires = "Capacidad de lanzar al menos un conjuro", description = "Magia de combate a quemarropa: más trucos, sin penalización por tener al enemigo encima y la opción de cambiar puntería por potencia.",
        traits = {
    ...
    {
        id = "feat_experto_armas_fuego", icon = "ability_hunter_lockandload", name = "Experto en armas de fuego", requires = "", description = "Manejo veterano de la pólvora: recargas sin perder el turno, disparas cómodo en corta distancia y encadenas un segundo tiro.",
        traits = {
    ...
    {
        id = "feat_adepto_armas_fuego", icon = "inv_scroll_11", name = "Adepto en armas de fuego", requires = "", description = "Formación básica en armas de fuego, con las herramientas de armero para mantenerlas a punto.",
        traits = {
    ...
    {
        id = "feat_maestro_armas_exoticas", icon = "inv_sword_109", name = "Maestro en armas exoticas", requires = "", description = "Adiestramiento en armamento poco común, del que casi nadie sabe sacar partido.",
        traits = {
    ...
    {
        id = "feat_mejor_quimica", icon = "inv_misc_5potionbag_special", requiredRaces = { "raza_goblin" }, name = "Mejor quimica", requires = "Goblin", description = "Instinto goblin para la alquimia: reconoces una poción de un vistazo y sabes sacarle más provecho.",
        traits = {
    ...
    {
        id = "feat_amigo_criaturas", icon = "eps_bg3_speakwithanimals", requiredRaces = { "raza_elfo_noche" }, name = "Amigo de las criaturas", requires = "Elfo nocturno", description = "Trato natural con las bestias: te entienden, te escuchan y rara vez te ven como una amenaza.",
        traits = {
    ...
    {
        id = "feat_herencia_darnassiana", icon = "ability_racial_shadowmeld", requiredRaces = { "raza_elfo_noche" }, name = "Herencia darnassiana", requires = "Elfo nocturno", description = "El legado de Darnassus: moverte sin ser visto en la penumbra y un espíritu que vela por ti cuando la muerte se acerca.",
        traits = {
    ...
    {
        id = "feat_fortaleza_enana", icon = "hots_xinzhao_determination", requiredRaces = { "raza_enano" }, name = "Fortaleza enana", requires = "Enano", description = "Aguante enano: cuando te cubres, aprovechas el respiro para recomponerte.",
        traits = {
    ...
    {
        id = "feat_abrazo_vacio", icon = "spell_necro_deathrift", requiredRaces = { "raza_elfo_vacio" }, name = "Abrazo del Vacio", requires = "Elfo del Vacio", description = "El Vacío responde a tu magia necrótica, la refuerza y te envuelve mientras la canalizas.",
        traits = {
    ...
    {
        id = "feat_rencor_faccion", icon = "eps_lol_gnar_ragegene", name = "Rencor de faccion", requires = "Cualquier raza", description = "Odio jurado a dos razas enemigas: las conoces, las lees y reaccionas antes ante ellas.",
        traits = {
    ...
    {
        id = "feat_depredador_endurecido", icon = "eps_wc3_enchantedbear", requiredRaces = { "raza_huargen" }, name = "Depredador endurecido", requires = "Huargen", description = "El instinto huargen a flor de piel: olfato, Correr a cuatro patas y garras que cuentan como arma.",
        traits = {
    ...
    {
        id = "feat_furia_orca", icon = "ability_warrior_deepcuts", requiredRaces = { "raza_orco" }, name = "Furia orca", requires = "Orco", description = "Furia orca en cada golpe, y una embestida más cuando la sangre ya te hierve.",
        traits = {
    ...
    {
        id = "feat_prodigio", icon = "inv_scroll_11", requiredRaces = { "raza_humano", "raza_renegado_humano" }, name = "Prodigio", requires = "Renegado (humano) o humano", description = "Versatilidad humana: aprendes deprisa una habilidad, una herramienta y un idioma, y dominas algo que ya sabías.",
        traits = {
    ...
    {
        id = "feat_guia_espiritual", icon = "eps_lol_profileicon_runespirit2", requiredRaces = { "raza_enano_martillo_salvaje", "raza_orco", "raza_tauren", "raza_trol" }, name = "Guia espiritual", requires = "Enano (Martillo Salvaje), orco, tauren o trol", description = "Los espíritus de tu pueblo te acompañan: sostienen tu ánimo y sanan a los tuyos.",
        traits = {
    ...
    {
        id = "feat_agilidad_robusta", icon = "ability_rogue_sprint", requiredRaces = { "raza_enano", "raza_gnomo", "raza_goblin" }, name = "Agilidad robusta", requires = "Enano, gnomo o goblin", description = "Cuerpo bajo y compacto, pero rápido: te mueves más y cuesta sujetarte.",
        traits = {
    ...
    {
        id = "feat_resistencia_tauren", icon = "inv_misc_nativebeastskin", requiredRaces = { "raza_tauren" }, name = "Resistencia Tauren", requires = "Tauren", description = "Corpulencia tauren: aguantas golpes sin armadura y tu vida crece con cada nivel.",
        traits = {
    ...
    {
        id = "feat_acechador", icon = "inv_scroll_11", requiredAbility = { abilities = { "Destreza" }, min = 13 }, name = "Acechador", requires = "Destreza 13 o mas", description = "Sabes esconderte donde otros no podrían, y un intento fallido no te delata.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_actor", icon = "inv_scroll_11", name = "Actor", description = "Talento para la imitación y el disfraz verbal: convences con la voz y con el gesto.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_afortunado", icon = "inv_misc_herb_goldclover_leaf", name = "Afortunado", description = "Una suerte inexplicable que puedes gastar cuando el dado no acompaña.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_alerta", icon = "ability_rogue_fleetfooted", name = "Alerta", description = "Nada te pilla desprevenido: reaccionas antes que nadie y no te sorprenden.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_apresador", icon = "inv_scroll_11", requiredAbility = { abilities = { "Fuerza" }, min = 13 }, name = "Apresador", requires = "Fuerza 13 o mas", description = "Pelea pegado al enemigo: agarrar, sujetar y castigar a quien tienes encima.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_atacante_carga", icon = "inv_scroll_11", name = "Atacante a la carga", description = "Aprovechas la carrera para rematarla con un golpe o una embestida.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_atacante_salvaje", icon = "inv_scroll_11", name = "Atacante salvaje", description = "Una vez por turno, repites el daño de un golpe cuerpo a cuerpo que no te convenza.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_atleta", icon = "inv_scroll_11", name = "Atleta", description = "Cuerpo entrenado: te levantas, trepas y saltas donde otros pierden el turno.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_azote_magos", icon = "inv_scroll_11", name = "Azote de magos", description = "Técnicas para ahogar la magia enemiga en cuanto la tienes al alcance.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_centinela", icon = "inv_scroll_11", name = "Centinela", description = "Nadie se escapa de tu lado: castigas a quien lo intenta y frenas a quien pasa.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_combatiente_dos_armas", icon = "inv_scroll_11", name = "Combatiente con dos armas", description = "Dominio de las dos manos: mejor guardia y golpes de la mano torpe.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_combatiente_montado", icon = "inv_scroll_11", name = "Combatiente montado", description = "A caballo eres otra cosa: proteges a tu montura y golpeas desde arriba.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_duelista_defensivo", icon = "inv_scroll_11", requiredAbility = { abilities = { "Destreza" }, min = 13 }, name = "Duelista defensivo", requires = "Destreza 13 o mas", description = "Con arma sutil, conviertes la parada en defensa cuando te van a impactar.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_duro", icon = "inv_scroll_11", name = "Duro", description = "Cuerpo curtido: aguantas mucho más castigo del que aparentas.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_experto_ballestas", icon = "inv_scroll_11", name = "Experto en ballestas", description = "La ballesta en tus manos no se atasca ni pierde ritmo, ni con el enemigo encima.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_explorador_mazmorras", icon = "inv_scroll_11", name = "Explorador de mazmorras", description = "Ojo entrenado para trampas y puertas secretas, y memoria para el terreno.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_habilidoso", icon = "inv_scroll_11", name = "Habilidoso", description = "Aprendizaje amplio: tres campos nuevos, a tu elección, entre habilidades y herramientas.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_iniciado_magia", icon = "inv_scroll_11", name = "Iniciado en la magia", description = "Un pie en otra tradición mágica: unos trucos y un conjuro prestados.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_lanzador_combate", icon = "inv_scroll_11", requiredCaster = "any", name = "Lanzador en combate", requires = "Capacidad de lanzar al menos un conjuro", description = "Lanzar bajo presión: no pierdes el conjuro por un golpe ni por tener las manos ocupadas.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_lanzador_preciso", icon = "inv_scroll_11", requiredCaster = "any", name = "Lanzador preciso", requires = "Capacidad de lanzar al menos un conjuro", description = "Puntería con la magia: tus ataques de conjuro no sufren por la cercanía ni por la cobertura.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_lanzador_ritual", icon = "inv_scroll_11", requiredAbility = { abilities = { "Inteligencia", "Sabiduria" }, min = 13 }, name = "Lanzador ritual", requires = "Inteligencia o Sabiduria 13 o mas", description = "Un libro propio de rituales que puedes lanzar sin gastar espacios.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_lider_inspirador", icon = "inv_scroll_11", requiredAbility = { abilities = { "Carisma" }, min = 13 }, name = "Lider inspirador", requires = "Carisma 13 o mas", description = "Una arenga antes del combate deja a los tuyos con aguante de sobra.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_ligeramente_acorazado", icon = "inv_scroll_11", name = "Ligeramente acorazado", description = "Entrenamiento con armadura ligera, para quien no la tenía.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_linguista", icon = "inv_scroll_11", name = "Linguista", description = "Estudio de lenguas y códigos: hablas más idiomas y escribes en clave.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_maestro_armas", icon = "inv_scroll_11", name = "Maestro de armas", description = "Práctica con un puñado de armas nuevas, elegidas por ti.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_maestro_escudero", icon = "inv_shield_05", name = "Maestro escudero", description = "El escudo como muro y como arma: protege a quien tienes al lado y derriba al que tienes delante.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_gran_maestro_armas", icon = "eps_bg3_multiattack", name = "Gran maestro de armas", description = "Armas grandes llevadas al límite: cambias puntería por daño y encadenas ataques cuando cae un enemigo.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_maestro_armaduras_medias", icon = "inv_scroll_11", requiredProficiency = { armor = "media" }, name = "Maestro en armaduras medias", requires = "Competente con armaduras medias", description = "Te mueves con armadura media como si no la llevaras.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_maestro_armaduras_pesadas", icon = "inv_scroll_11", requiredProficiency = { armor = "pesada" }, name = "Maestro en armaduras pesadas", requires = "Competencia con armaduras pesadas", description = "La armadura pesada desvía contigo golpes que a otros los matarían.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_maestro_armas_asta", icon = "inv_scroll_11", name = "Maestro en armas de asta", description = "Alabardas y lanzas largas: golpeas dos veces y castigas a quien se acerca.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_maestro_armas_pesadas", icon = "inv_scroll_11", name = "Maestro en armas pesadas", description = "Usas el peso del arma a tu favor y rematas a quien cae.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_maestro_escudos", icon = "inv_scroll_11", name = "Maestro en escudos", description = "El escudo también golpea: derribas y te cubres de lo que estalla.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_maton_taberna", icon = "inv_scroll_11", name = "Maton de taberna", description = "Pelea sucia: puños, botellas y cualquier cosa que esté a mano.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_mente_aguda", icon = "inv_scroll_11", name = "Mente aguda", description = "Memoria y orientación infalibles: sabes la hora, el rumbo y lo que se dijo.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_moderadamente_acorazado", icon = "inv_scroll_11", requiredProficiency = { armor = "ligera" }, name = "Moderadamente acorazado", requires = "Competencia con armaduras ligeras", description = "Entrenamiento con armadura media y escudo, para quien solo llevaba ligera.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_movil", icon = "inv_scroll_11", name = "Movil", description = "Rápido y escurridizo: cubres más terreno y te vas sin que te castiguen.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_muy_acorazado", icon = "inv_scroll_11", requiredProficiency = { armor = "media" }, name = "Muy acorazado", requires = "Competente con armaduras medias", description = "Entrenamiento con armadura pesada, para quien ya manejaba la media.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_observador", icon = "inv_scroll_11", name = "Observador", description = "Detalle que se te escapa, detalle que no existe; y además lees los labios.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_resiliente", icon = "spell_holy_devotionaura", name = "Resiliente", description = "Refuerzas una característica y aprendes a salvar con ella.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_resistente", icon = "inv_scroll_11", name = "Resistente", description = "Constitución de sobra: cada nivel te deja más vida de la que te corresponde.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_sanador", icon = "inv_scroll_11", name = "Sanador", description = "Manos de médico: levantas a un caído y curas más de lo normal con un botiquín.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_tirador_primera", icon = "inv_scroll_11", name = "Tirador de primera", description = "Disparos que otros dan por imposibles: distancia, cobertura y potencia a cambio de puntería.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_versado_armas", icon = "inv_scroll_11", name = "Versado en las armas", description = "Maniobras marciales prestadas, con su dado de superioridad.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_versado_elemento", icon = "inv_scroll_11", requiredCaster = "any", name = "Versado en un elemento", requires = "Capacidad de lanzar al menos un conjuro", description = "Eliges un elemento y tus conjuros de ese tipo pegan más y atraviesan resistencias.", source = "PHB",
        traits = {
    ...
    {
        id = "feat_iniciado_artificiero", icon = "inv_scroll_11", name = "Iniciado artificiero", description = "Un poco de la inventiva del artífice: un truco, un conjuro y herramientas.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_cocinero", icon = "inv_scroll_11", name = "Cocinero", description = "Cocina de campamento que alimenta el cuerpo y el ánimo de la partida.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_triturador", icon = "inv_scroll_11", name = "Triturador", description = "Golpes que desplazan: mueves al enemigo de sitio y le abres la guardia.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_adepto_sobrenatural", icon = "inv_scroll_11", requiredCaster = "class", name = "Adepto sobrenatural", requires = "Rasgo Lanzamiento de Conjuros o Magia del Pacto", description = "Desbloqueas una invocación sobrenatural del brujo.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_tocado_hadas", icon = "inv_scroll_11", name = "Tocado por las hadas", description = "La magia feérica te ha marcado: apareces donde no estabas y encantas a quien te mira.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_iniciado_combate", icon = "inv_scroll_11", requiredProficiency = { weapon = "marciales" }, name = "Iniciado en el combate", requires = "Competencia con un arma marcial", description = "Adoptas un estilo de combate y un truco marcial que lo acompaña.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_artillero_dote", icon = "inv_scroll_11", name = "Tirador (armas de fuego)", description = "Mano rápida con la pólvora: recargas sola y disparas sin miedo al cuerpo a cuerpo.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_adepto_metamagia", icon = "inv_scroll_11", requiredCaster = "class", name = "Adepto de la metamagia", requires = "Rasgo Lanzamiento de Conjuros o Magia del Pacto", description = "Aprendes a retorcer tus conjuros con los recursos del hechicero.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_perforador", icon = "inv_scroll_11", name = "Perforador", description = "Buscas el hueco de la armadura: repites el daño de tus golpes perforantes.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_envenenador", icon = "inv_scroll_11", name = "Envenenador", description = "Uso experto del veneno: lo aplicas sin perder el turno y atraviesas las defensas habituales.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_tocado_sombras", icon = "inv_scroll_11", name = "Tocado por las sombras", description = "El Páramo Sombrío te ha cambiado: te vuelves invisible y ves lo que otros no.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_experto_habilidades", icon = "inv_scroll_11", name = "Experto en habilidades", description = "Perfeccionas lo que ya sabías hasta convertirlo en pericia.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_cortador", icon = "inv_scroll_11", name = "Cortador", description = "Sabes dónde cortar: tus golpes cortantes frenan o ciegan al enemigo.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_telequinetico", icon = "inv_scroll_11", name = "Telequinetico", description = "Mueves objetos y empujas criaturas con la mente.", source = "TCoE",
        traits = {
    ...
    {
        id = "feat_telepata", icon = "inv_scroll_11", name = "Telepata", description = "Hablas mente a mente y puedes asomarte a los pensamientos ajenos.", source = "TCoE",
        traits = {
