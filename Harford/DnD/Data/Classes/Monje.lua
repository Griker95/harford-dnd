...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    features = {
        ...
        { id = "monje_artes_marciales", level = 1, name = "Artes marciales", type = "pasivo", description = "En el 1er nivel, tu práctica de las artes marciales te da maestría en estilos de combate que usan golpes desarmados y armas de monje, que son las espadas cortas y cualquier arma cuerpo a cuerpo simple que no tenga la propiedad de dos manos ni pesada.\n\nObtienes los siguientes beneficios mientras estás desarmado o empuñando solo armas de monje y no llevas armadura de malla o de placas, ni empuñas un escudo:\n\n• Puedes usar Destreza en lugar de Fuerza para las tiradas de ataque y daño de tus golpes desarmados y armas de monje. • Puedes tirar un d4 en lugar del daño normal de tu golpe desarmado o arma de monje. Este dado cambia a medida que ganas niveles como monje, como se muestra en la columna de Artes Marciales de la tabla de Monje. • Cuando usas la acción de Ataque con un golpe desarmado o un arma de monje en tu turno, puedes realizar un golpe desarmado como acción adicional. Por ejemplo, si tomas la acción de Ataque y atacas con un bastón, puedes realizar también un golpe desarmado como acción adicional.", effects = {
