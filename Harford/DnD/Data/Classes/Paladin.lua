...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    subclasses = {
        { id = "sagrado", name = "Sagrado", desc = "Luz sanadora y apoyo para los aliados.", features = {
            ...
            { id = "pal_sag_luz_amanecer", level = 3, name = "Canalizar: Luz del Amanecer", cast = "accion", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion: disipas la oscuridad magica en un cono de 9 metros frente a ti y liberas energia curativa. Restauras un total de puntos de golpe igual a cinco veces tu nivel de paladin, repartidos entre las criaturas que elijas dentro del cono. No afecta a no-muertos ni constructos.", effects = {} },
            { id = "pal_sag_martillo_luz", level = 3, name = "Canalizar: Martillo de Luz", cast = "accion", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion: golpeas el suelo con un martillo divino en un espacio a 9 metros; un pilar de luz sagrada de 1,5 metros de radio se alza. Cada criatura en el alcance hace una salvacion de Constitucion: 2d10 + tu nivel de paladin de dano radiante si falla, la mitad si tiene exito.", effects = {} },
        ...
        { id = "proteccion", name = "Proteccion", desc = "Guardian acorazado que protege a los suyos.", features = {
            ...
            { id = "pal_pro_consagracion", level = 3, name = "Canalizar: Consagracion", cast = "accion", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion: consagras el suelo en un radio de 9 metros. Cada criatura de tu eleccion en el rango hace una salvacion de Destreza: dano radiante igual a la mitad de tu nivel de paladin si falla, la mitad si tiene exito. Ademas, cada criatura de tu eleccion gana puntos de golpe temporales iguales a la mitad de tu nivel de paladin mas tu Mod. Carisma.", effects = {} },
            { id = "pal_pro_escudo_sagrado", level = 3, name = "Canalizar: Escudo Sagrado", cast = "accion_adicional", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion adicional: durante 1 minuto, las tiradas de ataque contra ti se hacen con desventaja. Ademas, una vez por turno, cuando una criatura te ataque puedes infligirle dano radiante igual a 1d6 mas la mitad de tu nivel de paladin.", effects = {} },
        ...
        { id = "represion", name = "Represion", desc = "Castigo sagrado que aniquila al impio.", features = {
            ...
            { id = "pal_ret_veredicto", level = 3, name = "Canalizar: Veredicto del Templario", cast = "accion_adicional", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion adicional: emites un veredicto contra una criatura a 9 metros. Obtienes ventaja en las tiradas de ataque contra ella durante 1 minuto, hasta que caiga a 0 puntos de golpe o quede inconsciente.", effects = {} },
            { id = "pal_ret_rechazar", level = 3, name = "Canalizar: Rechazar lo Profano", cast = "accion", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion: presentas tu simbolo sagrado. Cada demonio o no-muerto a 9 metros que pueda verte u oirte hace una salvacion de Sabiduria; si falla, queda apartado durante 1 minuto o hasta que reciba dano. Una criatura apartada gasta sus turnos alejandose de ti lo mas posible y no puede acercarse voluntariamente.", effects = {} },
