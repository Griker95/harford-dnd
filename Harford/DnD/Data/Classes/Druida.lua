...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    subclasses = {
        { id = "equilibrio", name = "Equilibrio", desc = "Magia lunar y solar que castiga al enemigo a distancia.", features = {
            ...
            { id = "dru_eq_conjuros_camino_5", level = 5, name = "Conjuros del camino", type = "informativo", grantedSpells = { "luz_del_dia", "oleada_estelar" }, description = "Nivel 5 del Camino del Equilibrio: Luz del dia y Oleada de estrellas (el estallido estelar del manual: texto identico del capitulo 6, linea de 30 m, 6d6 radiante). Siempre los tienes preparados y NO cuentan contra los conjuros que puedes preparar.", spellGrants = { { level = 3, ids = { "luz_del_dia", "oleada_estelar" } } }, effects = {} },
    ...
    features = {
        ...
        { id = "dru_lanzamiento_conjuros", level = 1, name = "Lanzamiento de conjuros", type = "pasivo", description = "Lanzas conjuros de druida usando Sabiduría (preparas Mod. Sabiduría + nivel). CD = 8 + comp + Mod. Sabiduría; ataque = comp + Mod. Sabiduría. Foco druidico.", effects = {} },
        ...
        ASI("druida", 4),
        { id = "dru_mejora_cambio_forma", level = 4, name = "Mejora de cambio de forma", type = "pasivo", description = "Ganas formas adicionales de Cambio de Forma, segun la tabla de Formas de Cambio: a nivel 4 la Forma Acuatica y la Forma de Viaje; a nivel 8 la Forma de Vuelo.", effects = {} },
