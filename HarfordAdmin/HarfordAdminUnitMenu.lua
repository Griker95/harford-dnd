...
local function RepossessNpc(snapshot)
    ...
    -- El motor de movimiento debe saber que ESTA posesion pretende controlar este GUID antes de
    -- mandar `.unposs` + `.poss`, como hace Atlas desde su boton Possess. Espera al pet correcto
    -- para no arrancar sobre la criatura que se esta soltando.
    if HarfordDnDAttackUI and HarfordDnDAttackUI.NotifyNpcPossessionRequested then
        HarfordDnDAttackUI.NotifyNpcPossessionRequested(snapshot.guid)
    end
