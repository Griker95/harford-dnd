...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    features = {
        { id = "cdm_renacer_oscuro", level = 1, name = "Renacer oscuro", type = "pasivo", description = "Como caballero de la muerte, caminas entre el mundo de los vivos y los muertos, existiendo en ambos y en ninguno.\n\n• Eres considerado tanto un humanoide como un no-muerto, lo cual te permite ser afectado por cualquier cosa que afecte a esos tipos de criatura. Por ejemplo, como no-muerto, puedes ser detectado por el Sentido Divino de un paladín, pero como humanoide, puedes ser sanado por su Imposición de Manos. • No necesitas dormir. En su lugar, entras en un estado semi-consciente, alimentando tu hambre eterna recordando el sufrimiento causado. Después de 4 horas en este estado, obtienes los mismos beneficios que un humano tras 8 horas de sueño. • Ventaja en las tiradas de salvación contra cualquier efecto que afecte exclusivamente a los no-muertos, como el conjuro *Encadenar no muertos* de un sacerdote.", effects = {} },
