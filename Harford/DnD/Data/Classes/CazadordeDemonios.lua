...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    features = {
        ...
        { id = "dh_evasion", icon = "spell_shadow_shadowward", level = 7, name = "Evasión", type = "informativo", description = "A nivel 7, tus agudos reflejos te permiten esquivar ciertos efectos de área, como el aliento ardiente de un dragón rojo o el conjuro de *tormenta de hielo*. Cuando estés sujeto a un efecto que te permita hacer una tirada de salvación de Destreza para recibir solo la mitad del daño, en su lugar no recibes daño si tienes éxito en la tirada de salvación, y solo recibes la mitad del daño si fallas.", effects = {} },
        { id = "dh_un_cazador_por_encima_de_todo", icon = "ability_demonhunter_specdps", level = 9, name = "Un Cazador por Encima de Todo", type = "informativo", description = "Al alcanzar el nivel 9, has perfeccionado tus instintos para cazar presas. Si pasas al menos 1 minuto observando a una criatura, obtienes ventaja en las pruebas de Sabiduría (Supervivencia) realizadas para rastrear a esa criatura hasta que la hayas matado, elijas una nueva presa o transcurran un número de días igual a tu nivel de cazador de demonios. Si pierdes el rastro de tu presa, puedes pasar 1 hora para percibir su dirección general en relación contigo, siempre y cuando ambos estén en el mismo plano de existencia. Además, en tu primer turno durante el combate, tienes ventaja en las tiradas de ataque realizadas contra la criatura.", effects = {} },
        { id = "dh_alas_demoniacas", icon = "ability_racial_flayer", level = 11, name = "Alas Demoníacas", type = "informativo", description = "A partir del nivel 11, puedes usar tu reacción cuando caigas para manifestar alas demoníacas, reduciendo cualquier daño por caída que recibas en una cantidad igual a cinco veces tu nivel de cazador de demonios. Además, durante la duración de tu Metamorfosis, obtienes una velocidad de vuelo igual a tu velocidad de movimiento.", effects = {} },
        { id = "dh_destreza_illidari", icon = "ability_parry", level = 11, name = "Destreza Illidari", type = "informativo", description = "A partir del nivel 11, cuando empuñas un arma cuerpo a cuerpo con la propiedad versátil, puedes usar el valor de daño aumentado incluso cuando la empuñas con una mano. Si decides empuñar el arma con dos manos, no recibes ningún beneficio adicional.", effects = {} },
        { id = "dh_purificado_por_las_llamas", icon = "spell_fire_twilightimmolation", level = 13, name = "Purificado por las Llamas", type = "informativo", description = "En el nivel 13, puedes usar tu acción y gastar 2 puntos de vil para envolver tu cuerpo en llamas de dolor y finalizar un efecto en ti que te cause estar encantado, asustado o envenenado. Cada criatura en un radio de 1,5 metros de ti cuando uses esta característica debe realizar una tirada de salvación de Destreza, recibiendo 1d10 + la mitad de tu nivel de cazador de demonios en daño por fuego si falla, o la mitad del daño si tiene éxito.", effects = {} },
        { id = "dh_mirada_reveladora", icon = "ability_hunter_snipershot", level = 14, name = "Mirada Reveladora", type = "informativo", description = "A partir del nivel 14, puedes concentrar el vil en tus ojos quemados para revelar la verdad del mundo que te rodea. Como acción, puedes gastar 3 puntos de vil para obtener los beneficios del conjuro *visión verdadera* durante 1 minuto.", effects = {} },
        { id = "dh_resiliencia_abisal", icon = "spell_shadow_demonicfortitude", level = 15, name = "Resiliencia Abisal", type = "informativo", description = "En el nivel 15, has adquirido una fortaleza superior. Ganas competencia en tiradas de salvación de Constitución.", effects = {} },
        { id = "dh_cuerpo_atemporal", icon = "spell_holy_blessingofagility", level = 18, name = "Cuerpo Atemporal", type = "informativo", description = "A partir del nivel 18, el vil primordial que fluye por tu cuerpo te ha concedido una longevidad inimaginable. Por cada 10 años que pasen, tu cuerpo envejece solo 1 año y no puedes ser envejecido mágicamente.", effects = {} },
        { id = "dh_preparado", icon = "ability_rogue_feint", level = 20, name = "Preparado", type = "informativo", description = "A nivel 20, tus sentidos sobrenaturales te permiten actuar al instante. Puedes tomar dos turnos durante la primera ronda de cualquier combate. Tomas tu primer turno en el conteo de iniciativa 30 y tu segundo turno en tu tirada de iniciativa. Además, cuando tires iniciativa y no tengas puntos de vil restantes, recuperas 2 puntos de vil.", effects = {} },
    },
}
