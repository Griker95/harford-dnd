...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    subclasses = {
        { id = "elemental", name = "Elemental", desc = "Desata rayos, fuego y tierra contra el enemigo a distancia.", features = {
            ...
            { id = "cha_ele_furia", level = 3, name = "Furia elemental", type = "pasivo", description = "Al lanzar un conjuro de daño elemental (acido/frío/fuego/rayo/trueno) puedes cambiar su tipo por otro de la lista.", effects = {} },
    ...
    features = {
        ...
        { id = "cha_lanzamiento_conjuros", level = 1, name = "Lanzamiento de conjuros", type = "pasivo", description = "Lanzas conjuros de chaman usando Sabiduría. CD = 8 + comp + Mod. Sabiduría; ataque = comp + Mod. Sabiduría. Foco druidico.", effects = {} },
