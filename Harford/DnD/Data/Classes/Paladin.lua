...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    subclasses = {
        { id = "sagrado", name = "Sagrado", desc = "Luz sanadora y apoyo para los aliados.", features = {
                { id = "pal_sagrado_conjuros_3", level = 3, name = "Conjuros de camino (Sagrado)", type = "informativo", grantedSpells = { "proteccion_contra_el_bien_y_el_mal" }, description = "Nivel 3: Proteccion contra el bien y el mal (falta Penitencia en el compendio). Los conjuros de camino siempre los tienes preparados y NO cuentan contra los conjuros de paladin que puedes preparar.", effects = {} },
                { id = "pal_sagrado_conjuros_5", level = 5, name = "Conjuros de camino (Sagrado)", type = "informativo", grantedSpells = { "prisma_sagrado", "restablecimiento_menor" }, description = "Nivel 5: Prisma sagrado y Restablecimiento menor. Los conjuros de camino siempre los tienes preparados y NO cuentan contra los conjuros de paladin que puedes preparar.", effects = {} },
            { id = "pal_sag_canalizar", level = 3, name = "Canalizar divinidad (sagrado)", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Opciones: Luz del Amanecer (disipa oscuridad y cura) y Martillo de Luz (estallido de luz, salvación de Constitución).", effects = {} },
            { id = "pal_sag_luz_amanecer", level = 3, name = "Canalizar: Luz del Amanecer", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion: disipas la oscuridad magica en un cono de 9 metros frente a ti y liberas energia curativa. Restauras un total de puntos de golpe igual a cinco veces tu nivel de paladin, repartidos entre las criaturas que elijas dentro del cono. No afecta a no-muertos ni constructos.", effects = {} },
            { id = "pal_sag_martillo_luz", level = 3, name = "Canalizar: Martillo de Luz", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion: golpeas el suelo con un martillo divino en un espacio a 9 metros; un pilar de luz sagrada de 1,5 metros de radio se alza. Cada criatura en el alcance hace una salvacion de Constitucion: 2d10 + tu nivel de paladin de dano radiante si falla, la mitad si tiene exito.", effects = {} },
            { id = "pal_sag_destello", level = 3, name = "Destello de Luz", type = "accion", actionKind = "flashOfLight", description = "Acción adicional + ranura de conjuro: curas a un objetivo a 20 pies (2d6 por ranura de 1er nivel, +1d6 por nivel superior, max 6d6).", effects = {} },
        } },
        { id = "proteccion", name = "Proteccion", desc = "Guardian acorazado que protege a los suyos.", features = {
                { id = "pal_proteccion_conjuros_3", level = 3, name = "Conjuros de camino (Proteccion)", type = "informativo", grantedSpells = { "santuario", "escudo_de_fe" }, description = "Nivel 3: Santuario y Escudo de fe. Los conjuros de camino siempre los tienes preparados y NO cuentan contra los conjuros de paladin que puedes preparar.", effects = {} },
                { id = "pal_proteccion_conjuros_5", level = 5, name = "Conjuros de camino (Proteccion)", type = "informativo", grantedSpells = { "guardian_del_rey" }, description = "Nivel 5: Guardian del rey (Castigo deslumbrante sin identificar). Los conjuros de camino siempre los tienes preparados y NO cuentan contra los conjuros de paladin que puedes preparar.", effects = {} },
            { id = "pal_pro_canalizar", level = 3, name = "Canalizar divinidad (proteccion)", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Opciones: Consagracion (radio 30 pies, daño radiante + PG temporal a aliados) y Escudo Sagrado (desventaja a atacantes; daño al fallar contra ti).", effects = {} },
            { id = "pal_pro_consagracion", level = 3, name = "Canalizar: Consagracion", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion: consagras el suelo en un radio de 9 metros. Cada criatura de tu eleccion en el rango hace una salvacion de Destreza: dano radiante igual a la mitad de tu nivel de paladin si falla, la mitad si tiene exito. Ademas, cada criatura de tu eleccion gana puntos de golpe temporales iguales a la mitad de tu nivel de paladin mas tu Mod. Carisma.", effects = {} },
            { id = "pal_pro_escudo_sagrado", level = 3, name = "Canalizar: Escudo Sagrado", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion adicional: durante 1 minuto, las tiradas de ataque contra ti se hacen con desventaja. Ademas, una vez por turno, cuando una criatura te ataque puedes infligirle dano radiante igual a 1d6 mas la mitad de tu nivel de paladin.", effects = {} },
        ...
        { id = "represion", name = "Represion", desc = "Castigo sagrado que aniquila al impio.", features = {
                { id = "pal_represion_conjuros_3", level = 3, name = "Conjuros de camino (Retribucion)", type = "informativo", grantedSpells = { "duelo_obligado", "golpe_furioso" }, description = "Nivel 3: Duelo obligado (duelo forzado) y Castigo furioso (castigo abrasador). Los conjuros de camino siempre los tienes preparados y NO cuentan contra los conjuros de paladin que puedes preparar.", effects = {} },
                { id = "pal_represion_conjuros_5", level = 5, name = "Conjuros de camino (Retribucion)", type = "informativo", grantedSpells = { "arma_magica" }, description = "Nivel 5: Arma magica (Castigo justo sin identificar). Los conjuros de camino siempre los tienes preparados y NO cuentan contra los conjuros de paladin que puedes preparar.", effects = {} },
            { id = "pal_ret_canalizar", level = 3, name = "Canalizar divinidad (represion)", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Opciones: Veredicto del Templario (ventaja en ataques contra una criatura 1 minuto) y Rechazar lo Profano (apartar demonios/no-muertos).", effects = {} },
            { id = "pal_ret_veredicto", level = 3, name = "Canalizar: Veredicto del Templario", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion adicional: emites un veredicto contra una criatura a 9 metros. Obtienes ventaja en las tiradas de ataque contra ella durante 1 minuto, hasta que caiga a 0 puntos de golpe o quede inconsciente.", effects = {} },
            { id = "pal_ret_rechazar", level = 3, name = "Canalizar: Rechazar lo Profano", type = "accion", resourceKey = "channel_divinity", resourceCost = 1, spendResourceOnAnnounce = true, description = "Accion: presentas tu simbolo sagrado. Cada demonio o no-muerto a 9 metros que pueda verte u oirte hace una salvacion de Sabiduria; si falla, queda apartado durante 1 minuto o hasta que reciba dano. Una criatura apartada gasta sus turnos alejandose de ti lo mas posible y no puede acercarse voluntariamente.", effects = {} },
            { id = "pal_ret_tormenta", level = 3, name = "Tormenta divina", type = "accion", actionKind = "divineStorm", description = "Al golpear, gasta ranura de conjuro: daño radiante a la criatura y a todo a 5 pies (salvación de Destreza por mitad). No se combina con Golpe del Cruzado.", effects = {} },
        } },
    },
    features = {
