...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    subclasses = {
        ...
        { id = "mejora", name = "Mejora", desc = "Imbuye sus armas con los elementos para el cuerpo a cuerpo.", casterType = "half", features = {
            ...
            slots = 2,
            options = {
                { id = "golpe_roca", label = "Golpe de Roca", desc = "Cuando golpeas con un ataque con arma, gastas 1 punto de torbellino para obligarla a una salvacion de Fuerza. Si falla, es empujada 4,6 metros directamente lejos de ti.", maneuver = { cost = 1, attack = true, spendOnHit = true, save = "Fuerza", outcome = "empujado 4,6 metros" } },
                { id = "mordida_roca", label = "Mordida de Roca", desc = "Cuando golpeas con un ataque con arma, gastas 1 punto de torbellino para intentar un golpe que derriba. Salvacion de Fuerza o cae derribado.", maneuver = { cost = 1, attack = true, spendOnHit = true, save = "Fuerza", outcome = "Derribado", onFailAura = 267937, conditionId = "prone" } },
                { id = "golpe_tormenta", label = "Golpe de Tormenta", desc = "Cuando golpeas con un ataque con arma, gastas 1 punto de torbellino para descargar un rayo. Salvacion de Constitucion o no podra tomar reacciones hasta el inicio de tu proximo turno.", maneuver = { cost = 1, attack = true, spendOnHit = true, save = "Constitucion", outcome = "sin reacciones" } },
                { id = "marca_hielo", label = "Marca de Hielo", desc = "Cuando golpeas con un ataque con arma, gastas 1 punto de torbellino para intentar una marca helada. Salvacion de Constitucion o tendra desventaja en ataques hasta el final de su proximo turno.", maneuver = { cost = 1, attack = true, spendOnHit = true, save = "Constitucion", outcome = "desventaja en ataques", onFailAura = 287295, conditionId = "chilled" } },
                { id = "latigo_elemental", label = "Latigo Elemental", desc = "Cuando golpeas con un ataque con arma, gastas 1 punto de torbellino para azotar a otra criatura a 4,6 metros de ella. Salvacion de Destreza o recibe 1d10 del tipo de dano de tu Afinidad Elemental.", maneuver = { cost = 1, attack = true, spendOnHit = true, save = "Destreza", outcome = "azotado por los elementos", damageDie = 10 } },
                { id = "golpe_torbellino", label = "Golpe de Torbellino", desc = "Al realizar la accion de ataque, gastas 1 punto de torbellino para que todos tus ataques con arma cuenten como magicos hasta el final de tu turno. Combinable con otro ataque con armas.", maneuver = { cost = 1, attack = true, spendOnHit = true } },
                { id = "golpe_impactante", label = "Golpe Impactante", requiresLevel = 7, desc = "Cuando golpeas con un ataque con arma, gastas 3 puntos de torbellino para intentar un golpe impactante. Salvacion de Constitucion o queda incapacitada hasta el inicio de tu proximo turno.", maneuver = { cost = 3, attack = true, spendOnHit = true, save = "Constitucion", outcome = "Incapacitado", conditionId = "incapacitated" } },
            } } },
    ...
    features = {
        ...
        ASI("chaman", 4),
        { id = "cha_bestia_espiritual", level = 5, name = "Bestia espiritual", type = "accion", description = "Accion: asumes la apariencia ilusoria de tu bestia espiritual. No cambia tus estadisticas salvo que tu velocidad pasa a 15 metros. Termina al lanzar un conjuro, atacar, o al usar tu accion adicional para volver a tu forma.", effects = {
