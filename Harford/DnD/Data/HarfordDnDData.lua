...
HarfordDnDData.TOOLS = {
    ...
    { id="ladron",       name="Herramientas de ladron" },
    { id="navegante",    name="Herramientas de navegante" },
    { id="envenenador",  name="Utiles de envenenador" },
    { id="instrumento",  name="Instrumento musical" },
    { id="juego",        name="Juego de azar" },
    { id="vehiculos_tierra", name="Vehiculos (terrestres)" },
    { id="vehiculos_agua",   name="Vehiculos (acuaticos)" },
}
...
HarfordDnDData.PRESENTATION = {
    ...
    ["rodar"] = {},
    ["serenidad"] = {},
    ["canalizar divinidad"] = {description = "Tu devocion te permite canalizar energia divina para alimentar dones sagrados. Recuperas los usos de Canalizar Divinidad al terminar un descanso corto o largo." },
    ["conjuros del sacerdocio de elune"] = {description = "Los conjuros de Elune estan siempre preparados y no cuentan contra tu limite de conjuros de sacerdote. Nivel 1: Encontrar familiar y Marca del cazador. Nivel 2: Rayo de luna y Oleada estelar. Nivel 3: Señal de esperanza y Explosión lunar. Nivel 4: Destierro e Invisibilidad mayor. Nivel 5: Curar heridas en masa y Carcaj veloz." },
    ["accion astuta"] = {description = "Puedes realizar Correr, Destrabarse o Esconderse como accion adicional." },
    ...
    ["ataque furtivo"] = {description = "Una vez por turno, cuando impactas con un arma ligera, de precision o a distancia, infliges dano extra si tienes ventaja o si un enemigo del objetivo esta a 5 pies de el y no estas en desventaja." },
    ["cambio de forma"] = {description = "Puedes usar tu accion para asumir magicamente una forma druidica que conozcas. Puedes volver a tu forma normal cuando quieras." },
    ["canalizar fuego demoniaco"] = {description = "Canalizas fuego demoniaco para alimentar tus tecnicas Illidari." },
    ["constitucion no muerta"] = {description = "Eres inmune a enfermedad, envenenado y hemorragia, y tienes resistencia al dano de veneno." },
    ...
    ["disparo arcano"] = {description = "Puedes convertir tus ataques a distancia contra una presa marcada en disparos arcanos: ignoran cobertura y causan dano de fuerza adicional al impactar." },
    ...
    ["espiral de la muerte"] = {description = "Como accion, gastas dados de Poder Runico para herir a una criatura visible a distancia o curar a una criatura no muerta." },
    ...
    ["golpe de escarcha"] = {description = "Cuando impactas con un arma, puedes canalizar escarcha runica para infligir dano adicional." },
    ["golpe del cruzado"] = {description = "Cuando impactas con un ataque cuerpo a cuerpo, puedes gastar un espacio de conjuro para infligir dano radiante adicional. El dano aumenta con el nivel del espacio." },
    ["golpe runico"] = {description = "Cuando impactas con un ataque cuerpo a cuerpo, puedes gastar dados de Poder Runico para infligir dano adicional." },
    ["guia ancestral"] = {description = "Los espiritus ancestrales guian tus acciones y sostienen a tus aliados." },
    ["imposicion de manos"] = {description = "Como accion, puedes extraer poder de tu reserva curativa para restaurar puntos de golpe a una criatura que toques. Tambien puedes gastar 5 puntos para curar una enfermedad o neutralizar un veneno." },
    ["iniciacion illidari"] = {description = "Has sobrevivido al entrenamiento Illidari y puedes usar Destreza en lugar de Fuerza para ataques y dano con gujas de guerra." },
    ["llamas del caos"] = {description = "Obtienes un ataque a distancia de fuego vil que usa Destreza para impactar y causar dano." },
    ["lobo solitario: ataque apuntado"] = {description = "Cuando no tienes mascota, puedes usar una accion adicional para obtener ventaja en tu proximo ataque con arma." },
    ["maquina de matar"] = {description = "La violencia de tus ataques alimenta tu eficacia marcial." },
    ["marca del cazador"] = {description = "Como accion adicional, marcas una presa visible. Una vez por turno, infliges dano adicional cuando la golpeas con un ataque con arma y tienes ventaja para encontrarla mediante Percepcion o Supervivencia." },
    ["metamorfosis"] = {description = "Como accion adicional, liberas el poder de tu demonio atado y entras en metamorfosis durante el tiempo indicado por el rasgo." },
    ...
    ["mordida de demonio"] = {description = "Tras realizar la accion de Ataque, puedes gastar Vil para hacer dos ataques con arma como accion adicional." },
    ...
    ["piromaniaco"] = {description = "Cuando obtienes el resultado maximo en un dado de dano de un conjuro de fuego, puedes volver a tirar uno de esos dados y sumar el nuevo resultado." },
    ["poder runico"] = {description = "Las energias necroticas se representan mediante una reserva de dados de Poder Runico que se recupera tras un descanso largo." },
    ["racha de calor"] = {description = "Cuando sacas el resultado maximo en un dado de dano de un conjuro, puedes volver a tirar uno de esos dados y sumar el resultado; una vez por turno." },
    ["renacer oscuro"] = {description = "Tu naturaleza no muerta te permite volver a levantarte mediante poder necrotico." },
    ["secretos profanos"] = {description = "Tu estudio de secretos prohibidos amplia tu dominio de la magia vil y oscura." },
    ["segundo aliento"] = {description = "Como accion adicional puedes gastar dados de golpe para recuperar puntos de golpe. Recuperas los dados gastados al descansar segun corresponda." },
    ["sentido divino"] = {description = "Como accion, detectas celestiales, infernales, no muertos y lugares u objetos consagrados o profanados dentro de 60 pies hasta el final de tu siguiente turno." },
    ...
    ["vil"] = {description = "Canalizas energia vil para alimentar las tecnicas de tu clase." },
    ["vision espectral"] = {description = "Tus cuencas oculares estan imbuidas de magia: puedes ver normalmente en oscuridad y percibir energias magicas segun el alcance de tu rasgo." },
}
...
HarfordDnDData.TRP3_PRESENTATION = {
    ...
    ["ira"] = {description = "Puntos maximos 2 || CD Salv 13\nGanas 1 punto de furia cuando infliges daño a una criatura con un ataque de arma que no hayas gastado puntos de furia en él. Puedes gastar estos puntos para realizar diversas maniobras. Para usar una de estas maniobras, debes gastar una cantidad de puntos de furia igual a su coste. No puedes tener más puntos de furia que tu nivel de Guerrero.  Tus puntos de furia acumulados permanecen durante 1 hora antes de disiparse, devolviendo tu reserva de furia a 0." },
