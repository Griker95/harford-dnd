...
API.REGISTRY = {
    -- ===== Mineria / Herreria =====
    ["mena_cobre"]     = { id = 14074575, name = "Mena de cobre" },
    ["mena_estano"]    = { id = 14074577, name = "Mena de estaño" },
    ["mena_hierro"]    = { id = 14074580, name = "Mena de hierro" },
    ["lingote_cobre"]  = { id = 14074638, name = "Barra de cobre" },
    ["lingote_bronce"] = { id = 14074641, name = "Barra de bronce" },
    ["daga_cobre"]     = { id = nil, name = "Daga de cobre" },
    ["espada_cobre"]   = { id = nil, name = "Espada de cobre" },

    -- ===== Herboristeria / Alquimia =====
    ["paciflor"]                = { id = 14074709, name = "Flor de paz" },
    ["terrablo"]                = { id = 14074711, name = "Raiz de tierra" },
    ...
    ["cuero_crudo_ligero"] = { id = 14074852, name = "Pellejo ligero" },
    ["cuero_ligero"]       = { id = 14074851, name = "Cuero ligero" },
    ...
    ["mena_plata"]          = { id = 14074579, name = "Mena de plata" },
    ["lingote_estano"]      = { id = 14074640, name = "Barra de estaño" },
    ["lingote_plata"]       = { id = 14074645, name = "Barra de plata" },
    ["cuero_basto"]         = { id = 14074860, name = "Cuero basto" },
    ["restos_cuero"]        = { id = 14074850, name = "Restos de cuero estropeado" },
    ["hojaplata"]           = { id = 14074710, name = "Hojaplata" },
    ["marregal"]            = { id = 14074712, name = "Marregal" },
    ["cardopresto"]         = { id = 14074713, name = "Cardopresto" },
    ["alga_estranguladora"] = { id = 14074715, name = "Alga estranguladora" },
    ["hierba_cardenal"]     = { id = 14074716, name = "Hierba cardenal" },
    ["musgo_tumba"]         = { id = 14074718, name = "Musgo de tumba" },

    -- ===== Ingenieria (cadena 1-300; IDs pendientes) =====
    ["polvo_tosco"]      = { id = nil, name = "Pólvora tosca" },
    ["pernos_cobre"]     = { id = nil, name = "Puñado de pernos de cobre" },
    ["dinamita_tosca"]   = { id = nil, name = "Dinamita tosca" },
    ["trabuco_tosco"]    = { id = nil, name = "Trabuco tosco" },
    ["tubo_bronce"]      = { id = nil, name = "Tubo de bronce" },
    ["catalejo_bronce"]  = { id = nil, name = "Catalejo de bronce" },
    ["soporte_hierro"]   = { id = nil, name = "Soporte de hierro" },
    ["rifle_hierro"]     = { id = nil, name = "Rifle de hierro" },
    ["carcasa_mithril"]  = { id = nil, name = "Carcasa de mithril" },
    ["girocronatomo"]    = { id = nil, name = "Girocronatomo" },
    ["detonador_goblin"] = { id = nil, name = "Detonador goblin" },

    -- ===== Ampliacion cadenas 1-300 (IDs pendientes: rellenar con el phase vault) =====
    ["aceroflor"] = { id = 14074717, name = "Acérita salvaje" },
    ...
    ["cuero_crudo_grueso"] = { id = 14074859, name = "Pellejo grueso" },
    ["cuero_crudo_medio"] = { id = 14074855, name = "Pellejo medio" },
    ["cuero_crudo_pesado"] = { id = 14074857, name = "Pellejo pesado" },
    ["cuero_grueso"] = { id = 14074858, name = "Cuero grueso" },
    ["cuero_medio"] = { id = 14074853, name = "Cuero medio" },
    ["cuero_pesado"] = { id = 14074856, name = "Cuero pesado" },
    ...
    ["lingote_acero"] = { id = 14074648, name = "Barra de acero" },
    ["lingote_hierro"] = { id = 14074646, name = "Barra de hierro" },
    ...
    ["matasuenos"] = { id = nil, name = "Matasueños" },
    ...
    ["polvo_extrano"] = { id = nil, name = "Polvo extraño" },
    ...
    ["zarzaespina"] = { id = 14074714, name = "Brezospina" },


    -- ===== Cadenas Classic / TBC (joyeria) / Lich (inscripcion) =====
    ["alambre_cobre"]               = { id = nil, name = "Alambre de cobre delicado" },
    ["anillo_ojotigre"]             = { id = nil, name = "Anillo de ojo de tigre" },
    ["baraja_presagios"]            = { id = nil, name = "Baraja de presagios" },
    ["bolsa_runica"]                = { id = nil, name = "Bolsa runica" },
    ["botas_cuero_curtido"]         = { id = nil, name = "Botas de cuero curtido" },
    ["botas_lana"]                  = { id = nil, name = "Botas de lana" },
    ["brazales_cobre"]              = { id = nil, name = "Brazales de cobre" },
    ["brazales_cuero"]              = { id = nil, name = "Brazales de cuero" },
    ["brazales_lana"]               = { id = nil, name = "Brazales de lana" },
    ["brazalete_zafiro"]            = { id = nil, name = "Brazalete de zafiro" },
    ["capa_cuero_grueso"]           = { id = nil, name = "Capa de cuero grueso" },
    ["capa_lana"]                   = { id = nil, name = "Capa de lana" },
    ["capa_seda"]                   = { id = nil, name = "Capa de seda" },
    ["capucha_magica"]              = { id = nil, name = "Capucha de tejido magico" },
    ["carne_especiada"]             = { id = nil, name = "Carne especiada" },
    ["carta_destino"]               = { id = nil, name = "Carta del destino" },
    ["coraza_torio"]                = { id = nil, name = "Coraza de torio" },
    ["cuero_curtido"]               = { id = nil, name = "Cuero curtido" },
    ["elixir_defensa"]              = { id = nil, name = "Elixir de defensa" },
    ["elixir_giganteza"]            = { id = nil, name = "Elixir de giganteza" },
    ["elixir_mente"]                = { id = nil, name = "Elixir de mente aguda" },
    ["engaste_bronce"]              = { id = nil, name = "Engaste de bronce" },
    ["engaste_oro"]                 = { id = nil, name = "Engaste de oro" },
    ["engaste_plata"]               = { id = nil, name = "Engaste de plata" },
    ["escudo_mithril"]              = { id = nil, name = "Escudo de mithril" },
    ["esencia_etérea"]              = { id = nil, name = "Esencia eterea" },
    ["esencia_veneno"]              = { id = nil, name = "Esencia de veneno" },
    ["espada_bastarda_acero"]       = { id = nil, name = "Espada bastarda de acero" },
    ["espada_torio"]                = { id = nil, name = "Espada de torio" },
    ["estatuilla_rubi"]             = { id = nil, name = "Estatuilla de rubi" },
    ["frasco_titanes"]              = { id = nil, name = "Frasco de los titanes" },
    ["gema_citrina"]                = { id = nil, name = "Citrina" },
    ["gema_ojotigre"]               = { id = nil, name = "Ojo de tigre" },
    ["gema_rubi"]                   = { id = nil, name = "Rubi carmesi" },
    ["gema_zafiro"]                 = { id = nil, name = "Zafiro estrella" },
    ["glifo_mayor"]                 = { id = nil, name = "Glifo mayor" },
    ["glifo_menor"]                 = { id = nil, name = "Glifo menor" },
    ["grebas_bronce"]               = { id = nil, name = "Grebas de bronce" },
    ["guanteletes_bronce"]          = { id = nil, name = "Guanteletes de bronce" },
    ["guantes_cuero_pesado"]        = { id = nil, name = "Guantes de cuero pesado" },
    ["guantes_seda"]                = { id = nil, name = "Guantes de seda" },
    ["guiso_cazador"]               = { id = nil, name = "Guiso del cazador" },
    ["hombreras_acero"]             = { id = nil, name = "Hombreras de acero" },
    ["hombreras_cuero"]             = { id = nil, name = "Hombreras de cuero" },
    ["lingote_oro"]                 = { id = nil, name = "Barra de oro" },
    ["lingote_verdadero"]           = { id = nil, name = "Barra de plata verdadera" },
    ["maza_hierro"]                 = { id = nil, name = "Maza de hierro" },
    ["mena_oro"]                    = { id = nil, name = "Mena de oro" },
    ["pantalones_lino"]             = { id = nil, name = "Pantalones de lino" },
    ["pantalones_magico"]           = { id = nil, name = "Pantalones de tejido magico" },
    ["pantalones_seda"]             = { id = nil, name = "Pantalones de seda" },
    ["pastel_carne"]                = { id = nil, name = "Pastel de carne" },
    ["pendiente_citrina"]           = { id = nil, name = "Pendiente de citrina" },
    ["pergamino_enc_botas"]         = { id = nil, name = "Pergamino: encantar botas" },
    ["pergamino_enc_capa"]          = { id = nil, name = "Pergamino: encantar capa" },
    ["pergamino_enc_escudo"]        = { id = nil, name = "Pergamino: encantar escudo" },
    ["piedra_afilar_pesada"]        = { id = nil, name = "Piedra de afilar pesada" },
    ["piedra_afilar_tosca"]         = { id = nil, name = "Piedra de afilar tosca" },
    ["piedra_densa"]                = { id = nil, name = "Piedra densa" },
    ["piedra_gruesa"]               = { id = nil, name = "Piedra gruesa" },
    ["piedra_pesada"]               = { id = nil, name = "Piedra pesada" },
    ["piedra_solida"]               = { id = nil, name = "Piedra solida" },
    ["pigmento_umbrio"]             = { id = nil, name = "Pigmento umbrio" },
    ["pocion_invisibilidad"]        = { id = nil, name = "Pocion de invisibilidad" },
    ["pocion_mana"]                 = { id = nil, name = "Pocion de mana" },
    ["pocion_mana_menor"]           = { id = nil, name = "Pocion de mana menor" },
    ["polvo_iluminado"]             = { id = nil, name = "Polvo iluminado" },
    ["retal_runico"]                = { id = nil, name = "Retal de tela runica" },
    ["sopa_verduras"]               = { id = nil, name = "Sopa de verduras" },
    ["tela_runica"]                 = { id = nil, name = "Tela runica" },
    ["tinta_ambar"]                 = { id = nil, name = "Tinta ambar" },
    ["tinta_esmeralda"]             = { id = nil, name = "Tinta esmeralda" },
    ["tinta_tenue"]                 = { id = nil, name = "Tinta tenue" },
    ["tinta_umbria"]                = { id = nil, name = "Tinta umbria" },
    ["tunica_runica"]               = { id = nil, name = "Tunica runica" },
    ["ungüento_curativo"]           = { id = nil, name = "Unguento curativo" },
    ["varita_menor"]                = { id = nil, name = "Varita magica menor" },
    ["vendaje_runico"]              = { id = nil, name = "Vendaje de tela runica" },
    ["veneno_debilitante"]          = { id = nil, name = "Veneno debilitante" },
    ["veneno_mortal"]               = { id = nil, name = "Veneno mortal" },
    ["veneno_paralizante"]          = { id = nil, name = "Veneno paralizante" },
    ["veneno_sombrio"]              = { id = nil, name = "Veneno de las sombras" },
    ["veta_verdadera"]              = { id = nil, name = "Veta verdadera" },
    ["yelmo_cobre"]                 = { id = nil, name = "Casco de cobre" },
    ["yelmo_hierro"]                = { id = nil, name = "Yelmo de hierro" },
    ["yelmo_mithril"]               = { id = nil, name = "Yelmo de mithril" },
}
