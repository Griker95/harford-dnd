...
function HarfordDnDComm.CreateHandlers(deps)
    ...
    handlers.HandleAddonMessage = function(prefix, message, sender, channel)
        ...
        if HarfordSync.DeserializeRequestedSave then
            local saveAbility, saveDC, saveOutcome, saveAura, saveCondition, saveDuration, saveTurns, saveSourceGuid, saveSourceName, saveExtraDice, saveExtraType, saveSkill, saveActionName =
            ...
            if saveAbility then
                ...
                if deps.HandleRequestedSave then
                    deps.HandleRequestedSave(saveAbility, saveDC, saveOutcome, saveAura, sender,
                        saveCondition, saveDuration, saveTurns, saveSourceGuid, saveSourceName, saveExtraDice, saveExtraType, saveSkill, saveActionName)
                end
                return false
            end
        end
