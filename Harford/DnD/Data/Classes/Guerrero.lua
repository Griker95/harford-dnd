...
API.CLASSES[#API.CLASSES + 1] =
{
    ...
    features = {
        ...
        { id = "guerrero_man_desarme", icon = "ability_warrior_disarm", level = 2, name = "Desarme", type = "maniobra", description = "Puedes gastar 2 puntos de ira cuando hagas un ataque de arma para intentar un golpe desarmador. Si el ataque impacta, inflige daño normal y el objetivo suelta el arma u objeto que sostiene.", effects = {
        ...
        { id = "guerrero_man_carga", icon = "ability_warrior_charge", level = 2, name = "Carga", type = "maniobra", description = "Cuando realizas la acción de Correr y te desplazas al menos 20 pies hacia un objetivo, puedes gastar 1 punto de ira y realizar un ataque de arma contra él como parte de la acción de Correr. Este ataque se realiza con ventaja.", effects = {
