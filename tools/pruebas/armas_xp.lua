...
local melee = W.GetAttackRange({ key = "Espada", mode = "Melee", props = {} })
chk("melee permite una yarda desde hitbox", D.CheckDistance(0.9144, melee).ok, true)
chk("melee permite menos de una yarda", D.CheckDistance(0.5, melee).ok, true)
chk("melee bloquea mas de una yarda", D.CheckDistance(0.915, melee).ok, false)
chk("toque conserva contacto", D.CheckDistance(0.5, spellRange).ok, false)
