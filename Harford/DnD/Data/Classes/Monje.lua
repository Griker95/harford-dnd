...
API.CLASSES[#API.CLASSES + 1] =
{
        ...
        { id = "cervecero", name = "Maestro cervecero", desc = "Muro resistente que aguanta y dispersa el daño.", features = {
            ...
            { id = "monje_cer_brebajes", level = 3, name = "Cervecero elusivo", actionKind = "optionAbility", bookHidden = true, type = "choice", description = "Canalizas tu chi en brebajes. Conoces el Brebaje del Buey Negro y UNO mas a tu eleccion; aprendes otro a los niveles 6, 11 y 17. Usarlos cuesta una accion y sus puntos de chi cada vez, y necesitas un frasco de liquido potable contigo.", effects = {}, choice = {
                ...
                options = {
                    ...
                    { id = "piel_hierro", label = "Brebaje de Piel de Hierro", resourceKey = "chi", resourceCost = 2, requiresLevel = 6, selfCondition = { id = "piel_hierro", duration = "rounds", turns = 10 }, desc = "Gastas 2 puntos de chi para ganar resistencia al dano contundente, perforante y cortante infligido por ataques no magicos durante 1 minuto." },
            ...
            { id = "monje_cer_elaboracion_ligera", level = 11, name = "Elaboración Ligera", type = "informativo", description = "A partir del 11º nivel, cuando usas tu acción para beber un brebaje, puedes realizar un golpe desarmado como acción adicional. En el 17º nivel, esto aumenta a dos golpes desarmados.", effects = {} },
    ...
    features = {
        ...
        { id = "monje_chi_danza", level = 2, name = "Danza Elusiva", cast = "accion_adicional", type = "accion", resourceKey = "chi", resourceCost = 1, spendResourceOnAnnounce = true, description = "Gastas 1 punto de chi para tomar la accion de Esquivar como accion adicional en tu turno.", effects = {} },
        { id = "monje_chi_paso", level = 2, name = "Paso del Viento", cast = "accion", type = "accion", resourceKey = "chi", resourceCost = 1, spendResourceOnAnnounce = true, description = "Gastas 1 punto de chi para tomar la accion de Desengancharse o Correr como accion adicional en tu turno, y tu distancia de salto se duplica ese turno.", effects = {} },
        { id = "monje_chi_efusion", level = 2, name = "Efusion", cast = "accion_adicional", type = "accion", resourceKey = "chi", resourceCost = 1, spendResourceOnAnnounce = true, description = "Gastas 1 punto de chi y usas tu accion adicional para tocar a una criatura: recupera puntos de golpe iguales a tu Mod. Sabiduria.", effects = {} },
