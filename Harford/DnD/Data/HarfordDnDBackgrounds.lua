...
API.BACKGROUNDS = {
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "bg_merc_herr", name = "Herramienta adicional", type = "choice", description = "Escoge una herramienta adicional: herramientas de ladron, vehiculos terrestres, vehiculos acuaticos o un instrumento musical.", choice = { slots = 1, options = {
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "bg_alt_peso", name = "Peso de un reino caido", type = "informativo", description = "Puedes identificar a otros exiliados o simpatizantes de Alterac mediante gestos, acentos o simbolos ocultos. Obtienes ventaja en pruebas de Carisma (Persuasion o Engaño) o de Historia cuando trates con individuos marcados por el exilio, la derrota o el legado de la Segunda Guerra. Tambien puedes encontrar refugio entre comunidades marginales, contrabandistas o grupos de exiliados que aun recuerdan a Alterac.", effects = {} },
    ...
    {
        id = "cruzado_argenta", name = "Cruzado Argenta", source = "Harford",
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "bg_des_saboteador", name = "Saboteador", type = "informativo", description = "Conoces rutinas militares y puntos debiles de campamentos, patrullas y suministros, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_ere_perspicacia", name = "Perspicacia erudita", type = "informativo", description = "Tu retiro y estudio te permiten reconocer claves historicas, simbolicas o personales que otros pasan por alto, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_luna_idioma", name = "Idioma", type = "informativo", description = "Un idioma de tu eleccion.", effects = {} },
            { id = "bg_luna_actuacion", name = "Actuacion hipnotica", type = "informativo", description = "Sabes atraer atencion, distraer y leer al publico mediante espectaculo y misterio, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            { id = "bg_elu_competencias", name = "Competencias", type = "pasivo", description = "Competencia en Medicina y Religion.", effects = {
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "bg_for_idioma", name = "Idioma", type = "informativo", description = "Un idioma cualquiera de tu eleccion.", effects = {} },
            { id = "bg_for_mirada", name = "Todos se fijan en ti", type = "informativo", description = "Tu presencia forastera puede abrir conversaciones, despertar sospechas o atraer ayuda por curiosidad, a discrecion del DM.", effects = {} },
        },
    },
    {
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "bg_gsal_voz", name = "Voz de la naturaleza", type = "informativo", description = "Puedes interpretar señales naturales y tratar con comunidades o guardianes vinculados a lo salvaje, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_guardia_ojo", name = "Ojo de guardian", type = "informativo", description = "Conoces rutinas urbanas, jerarquias locales y señales de problemas en una ciudad, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_hered_idioma", name = "Idioma", type = "informativo", description = "Un idioma cualquiera de tu eleccion.", effects = {} },
            { id = "bg_hered_rasgo", name = "Herencia", type = "informativo", description = "Tu herencia puede darte acceso, interes, enemistades o autoridad segun su naturaleza, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_org_idiomas", name = "Idiomas", type = "informativo", description = "Dos idiomas de tu eleccion.", effects = {} },
            { id = "bg_org_refugio", name = "Refugio", type = "informativo", description = "Puedes solicitar ayuda, informacion o refugio limitado a miembros de tu organizacion, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_anillo_sintonia", name = "Sintonia elemental", type = "informativo", description = "Puedes interpretar señales elementales y tratar con chamanes o comunidades ligadas al Anillo de la Tierra, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_tribal_naturaleza", name = "Uno con la naturaleza", type = "informativo", description = "Tu comunidad y sus costumbres te ayudan a comprender tierras salvajes, clanes y tradiciones locales, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_liga_idioma", name = "Idioma", type = "informativo", description = "Un idioma de tu eleccion.", effects = {} },
            { id = "bg_liga_pionero", name = "Pionero audaz", type = "informativo", description = "Puedes obtener ayuda, rumores o acceso a recursos basicos de expedicionarios, arqueologos y exploradores, a discrecion del DM.", effects = {} },
        },
    },
    {
    ...
    {
        id = "protector_cenarion", name = "Protector Cenarion", source = "Harford",
        aliases = { "cenarion", "protector cenarion" },
        desc = "Sirves o colaboras con el Circulo Cenarion, defendiendo el equilibrio natural frente a corrupcion, guerra o abuso.",
        traits = {
    ...
    },
    {
        ...
        traits = {
            ...
            { id = "bg_cat_marcado", name = "Marcado pero en pie", type = "informativo", description = "Tu experiencia con desastres te ayuda a reconocer riesgos, sobrevivientes, ruinas o traumas similares, a discrecion del DM.", effects = {} },
        },
    },
    {
        id = "rostro_olvidado", name = "Rostro olvidado", source = "Harford",
        desc = "En un mundo donde el pasado nunca muere del todo, tu lo mataste primero. Fingiste tu muerte para escapar de la justicia y ahora vives con un nuevo nombre y un nuevo rostro, aunque el eco de tus pecados todavia te sigue.",
        traits = {
            { id = "bg_rostro_comp", name = "Competencias", type = "pasivo", description = "Competencia en Engaño y Sigilo.", effects = {
                { kind = "skillProf", skill = "Engano" }, { kind = "skillProf", skill = "Sigilo" },
            } },
            { id = "bg_rostro_sombras", name = "Vida entre sombras", type = "informativo", description = "Has perfeccionado el arte de vivir sin dejar rastro. Puedes crear identidades falsas con facilidad y sabes como manipular registros, sellos y lenguaje corporal para mantener una fachada convincente. Puedes gastar una hora y 5 po para establecer una identidad falsa en una localidad, con documentacion y contactos creibles. Mientras mantengas esta identidad, ganas ventaja en tiradas de Engano y Sigilo al interactuar con autoridades o figuras publicas que no conozcan tu verdadero rostro. Una vez por descanso largo, puedes evitar ser reconocido magicamente, como con localizar criatura o videncia, siempre que estes usando tu identidad falsa. En ciudades o asentamientos, puedes encontrar un contacto util (informante, falsificador, contrabandista) que te ofrezca informacion o refugio temporal, a discrecion del DM.", effects = {} },
        },
    },
    {
        ...
        traits = {
            ...
            { id = "bg_caz_herr", name = "Herramientas", type = "choice", description = "Elige dos conjuntos de herramientas entre un juego, un instrumento musical y herramientas de ladron.", choice = { slots = 2, options = {
                { id = "juego", label = "Juego", effects = { Tool("Un juego") } },
                { id = "instrumento", label = "Instrumento musical", effects = { Tool("Instrumento musical") } },
    ...
    },
    {
        ...
        desc = "Entre los tuneles industriales de Mecandria y el eco vibrante de sus maquinas, desarrollaste un talento unico para percibir sonidos que ningun otro gnomo podia captar.",
        traits = {
            { id = "bg_coneja_escucha", name = "Escucha resonante conejil", type = "informativo", description = "Obtienes ventaja en pruebas de Sabiduria (Percepcion) basadas en escuchar. Tienes un comunicador interno de voz que funciona como una radio y te permite escuchar y enviar mensajes a traves de el. Puedes detectar sonidos sutiles como engranajes ocultos, mecanismos tensos, relojeria, pasos lejanos, susurros amortiguados y vibraciones metalicas.", effects = {} },
            { id = "bg_coneja_acuajet", name = "Acuajet", type = "informativo", description = "Arma exotica que requiere sintonizacion por Ellie Bunny. Es un fusil integrador gnomico con varios modos de funcionamiento: funciona como foco arcano y permite lanzar magia curativa o elemental sin componentes materiales. Canon de agua (Curacion): permite lanzar conjuros curativos como si tuvieras Hechizo Lejano; si el hechizo tiene alcance de toque, pasa a 30 pies, y si tiene alcance numerico, se duplica. Canon de aire (Proyectil): ataque a distancia (18/60 m), dano 1d4 + Destreza perforante, usando municion improvisada como tuercas, clavos, perdigones o tornillos. Canalizacion elemental: los conjuros elementales pueden describirse como proyectiles canalizados por el arma sin cambios mecanicos.", effects = {} },
        },
    },
    {
        id = "eco_resurreccion", name = "Eco de resurreccion", source = "Harford",
        aliases = { "eco de resurreccion" },
        desc = "Tras morir y regresar a la vida, quedaste marcado por el umbral entre ambos mundos y percibes a los seres vivos como sombras rodeadas de mana y energias magicas.",
        traits = {
            { id = "bg_eco_vision", name = "Vision espectral", type = "informativo", description = "Puedes percibir almas y energias magicas de los seres vivos: criaturas como sombras con un nucleo brillante, rodeadas por el mana y las energias que portan. El uso prolongado fatiga tu vista y tu mente. Puedes identificar de forma aproximada el tipo de magia predominante de una criatura, rastros recientes de magia residual y corrupciones, alteraciones o energias anomalas visibles.", effects = {} },
        },
    },
    {
